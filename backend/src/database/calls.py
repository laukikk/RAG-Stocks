...
def create_account(db: Session, user_id: int, account_type: str, currency: str = 'USD') -> Account:
...
def create_stock(db: Session, symbol: str, company_name: str, 
...
def add_portfolio_holding(db: Session, account_id: int, stock_id: int, 
...
def create_order(db: Session, account_id: int, stock_id: int, 
...
def record_transaction(db: Session, account_id: int, stock_id: int, 
...
def add_watchlist_item(db: Session, watchlist_id: int, stock_id: int) -> WatchlistItem:
...
def record_stock_daily_price(db: Session, stock_id: int, date: date, 
...
def get_stock_price_history(db: Session, stock_id: int, 
...
def get_stock_performance(db: Session, stock_id: int, 
                            days: int = 30) -> dict:
